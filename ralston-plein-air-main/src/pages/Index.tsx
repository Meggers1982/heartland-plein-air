...
const general = categories.find((c) => c.id === "general")!.items;
const purchasing = categories.find((c) => c.id === "purchasing")!.items;
const homepageFaqs = [general[0], general[1], general[2], purchasing[0], general[3]];
