    ...
    items: [
      {
        ...
        a: "The inaugural Heartland Plein Air Festival brings together 25 nationally acclaimed invited artists representing 20 states. The festival also includes an Open Division for artists who apply through the website, so the total number of participating artists will be larger.",
      },
      {
      ...
      },
      {
        ...
        a: "Plein air artists work in a range of mediums, and the Heartland Plein Air Festival doesn't restrict artists to a single one. Oil paint is the classic choice — it's what Monet and Renoir used, and it's still the most popular medium for capturing the nuances of light and atmosphere outdoors. Watercolor is another longtime favorite, valued for its portability and the spontaneous quality it brings to outdoor work. Pastel is widely used for its speed and brilliant, unmixed color. Acrylic is a more recent addition, drying quickly and working well in a range of conditions. Expect to see a mix across the festival's participating artists.",
      },
      {
      ...
      },
      {
        ...
        a: "Every painting exhibited and sold at Heartland Plein Air will be created on-site during the festival week, September 13–19, 2026. Artists paint directly from life at locations across the Omaha Metro — nothing is brought from home or finished in a studio beforehand.",
      },
      {
        q: "Will there be artist demonstrations or workshops?",
        a: "Education and artist demonstrations are woven into the entire festival week. Before the festival officially opens, a Pre-Festival Youth Paint Out runs September 12 at Wildwood Park (10 AM–2 PM), followed by a youth exhibition that evening at the Baright Library (5–7 PM). On September 16, Youth-Professional Artist Mentor Sessions pair young artists with the festival's invited professionals (4–5:30 PM). On September 17, the festival's Judge of Awards, Rick J. Delanty, will give a public Artist Lecture at the Baright Library (5555 S. 77th Street, Ralston) from 5–6 PM. Throughout the week, invited artists also provide educational workshops for local students and foster children.",
      },
      {
        q: "Are there awards or competitions during the festival?",
        a: "The festival offers over $10,000 in awards, with Quick Paint competitions running throughout the week. Lunchtime competitions take place in Benson (September 14), Dundee (September 15), and the Cathedral & Castle district (September 16), with an evening Quick Paint in Ralston on September 17. The awards ceremony is held at the Collector's Soiree on September 18. All judging is handled by Rick J. Delanty — a nationally recognized painter holding memberships in AIS, OPA, LPAPA, and ASMA, and recognized as an ARC Salon Living Master.",
      },
      {
        q: "Can children or beginner artists participate?",
        a: "Young artists are genuinely central to this festival, not an afterthought. A Pre-Festival Youth Paint Out takes place September 12 at Wildwood Park, with a youth exhibition that same evening at the Baright Library. Youth-Professional Artist Mentor Sessions on September 16 connect young painters directly with the festival's invited professionals. The festival also coordinates programming specifically for foster children. For adult artists at any skill level, the Open Division offers a path to compete alongside nationally invited painters.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "The Quick Paint competitions are the most reliable option — all participating artists gather at a single location at the same time, so you get to watch many painters working simultaneously. Those take place at lunchtime in Benson on September 14, Dundee on September 15, and the Cathedral & Castle district on September 16, and in the evening in Ralston on September 17. Outside of those events, artists paint freely across the metro, so sightings are more spontaneous. A map of suggested painting locations will be available on HeartlandPleinAir.org to help you plan.",
      },
      {
        q: "What days and times is the festival open?",
        a: "The festival runs September 13–19, 2026, with a pre-festival youth day on September 12. Key public events: Sept 12 — Youth Paint Out at Wildwood Park (10 AM–2 PM) and Youth Exhibition at Baright Library (5–7 PM). Sept 14–16 — Lunchtime Quick Paint competitions in Benson, Dundee, and Cathedral & Castle. Sept 16 — Youth-Professional Mentor Sessions (4–5:30 PM). Sept 17 — Artist Lecture by Judge Rick J. Delanty at Baright Library (5–6 PM); Evening Quick Paint in Ralston (6–8 PM). Sept 18 — Collector's Soiree at the Granary, Ralston (5–8 PM, ticketed). Sept 19 — Public Exhibition at the Granary, Ralston (1–4 PM, free). Sept 19–Oct 2 — Online art sale at HeartlandPleinAir.org and RalstonArts.org.",
      },
      {
        q: "Is the festival family-friendly?",
        a: "The Heartland Plein Air Festival is designed with all ages in mind. Youth programming runs throughout the entire week — including paint-outs, a youth art exhibition, and mentorship sessions pairing young artists with festival professionals. The Public Exhibition is free, and watching artists paint at outdoor locations across the metro is a casual, come-and-go experience that works well for families.",
      },
      {
        q: "Will food or drinks be available?",
        a: "The Collector's Soiree on September 18 includes catering and entertainment as part of the ticketed event at the Granary. Food and drink availability at the Quick Paint locations and the Public Exhibition is not specified in current festival materials — check HeartlandPleinAir.org for updates closer to the event.",
      },
      {
        q: "Is there a map of artist painting locations?",
        a: "A map of Quick Paint competition sites and suggested painting locations across the metro is in development and will be available on the Schedule page.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Pricing is set by each individual artist and won't be published in advance. Across the broader plein air market, works tend to range from a few hundred dollars on the lower end to several thousand for more established artists. The Heartland Plein Air Festival features nationally acclaimed painters, so expect a range of price points across both the Collector's Soiree and the Public Exhibition. Plein air paintings are generally considered more accessible than comparable gallery work, which is part of what makes festival exhibitions such a good opportunity for collectors at any level.",
      },
      {
        q: "Can I purchase artwork before the final exhibition?",
        a: "The Collector's Soiree on September 18 — the evening before the Public Exhibition — is the earliest opportunity to purchase artwork. Whether works are available for sale at any point earlier in the week is not specified in current festival materials.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Sponsorship opportunities are available for businesses that want to be part of the inaugural Heartland Plein Air Festival. Current partners include the Benson Creative District, Historic Dundee Creative District, Castle & Cathedral Creative District, Visit Nebraska, the Wiebe Ralston Foundation, Nebraska Arts Council, and the Nebraska Cultural Endowment. For information on sponsorship levels and benefits, contact the Ralston HINGE Creative District directly.",
      },
      {
        q: "Are volunteer opportunities available?",
        a: "Volunteers are being recruited to support the festival across a range of roles. Specific sign-up details aren't yet published — check HeartlandPleinAir.org or reach out to the festival organizers directly for the latest information.",
      },
      {
        q: "How can I become a festival sponsor?",
        a: "Sponsorship inquiries can be directed through HeartlandPleinAir.org. For a direct conversation, contact City Administrator Jack Cheloha at 402.331.6677 or jcheloha@cityofralston.com.",
      },
      {
        q: "Does the festival partner with local nonprofits or schools?",
        a: "Community partnerships are a core part of how the Heartland Plein Air Festival operates. Invited artists provide educational workshops for local students and foster children throughout the week, and the festival's youth programming is built in collaboration with area schools and youth organizations. The organizing body — the Ralston HINGE Creative District — is itself a 501(c)(3) nonprofit, and the event is co-presented with multiple Omaha Metro creative districts, including Benson, Dundee, and Castle & Cathedral.",
      },
      {
        q: "How does the festival support the local arts community?",
        a: "The Heartland Plein Air Festival was established specifically to use the arts as an economic driver for the Ralston and Omaha Metro region. Supported in part by a Nebraska Arts Council Creative District Development Grant, the festival is designed to attract visitors, generate economic activity, and put Ralston on the national map as an arts destination. During the week, 24 nationally recognized artists bring collector interest and visibility to the region. Youth programming creates direct mentorship opportunities for local students and foster children. And because this is intended as an annual event, the cultural and economic impact is designed to grow year over year.",
      },
    ],
  },
];
