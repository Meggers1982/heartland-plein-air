...
const CountdownBanner = () => {
  ...
  return (
    <section
      ...
      aria-label="The Heartland Plein Air Arts Festival runs September 13–19, 2026 in Douglas and Sarpy County"
    >
      {/* Subtle texture wash */}
      <div
        aria-hidden
      ...
      />
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-8 px-6 py-4">
