      ...
      <div className="mx-auto max-w-6xl px-6">
        <AnimatedSection className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl font-body text-base leading-relaxed text-muted-foreground">
            Nationally recognized painters from across the country are descending on the Omaha metro — easels, brushes, and all — to capture Douglas & Sarpy County in real time. Meet one of them.
          </p>
        </AnimatedSection>
